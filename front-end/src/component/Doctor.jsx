...
const Doctor = () => {
  ...
  const [subMeu, setSubMenu] = useState("chamber");
  ...
  const getUserDetails = useCallback(async () => {
    const { data } = await getDoctorInfo(userId);
          ...
          <Table
            ...
            dataSource={[
              ...
              },
              {
                ...
                name: "Jim Green",
                age: "Specialist",
                address: userDetails.specialist,
                tags: ["loser"],
              },
              {
                key: "3",
                name: "Joe Black",
                age: "MBBS",
                address: userDetails.mbbsInstitue,
              },
              {
                key: "4",
                name: "fd",
              ...
              },
              {
                ...
                name: "fd",
                age: "Current Profession",
                address: userDetails.currentProfession,
              },
            ]}
          />
        </UseInfoSide>
